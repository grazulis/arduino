...
#define ECHO_PIN     7  // Arduino pin tied to echo pin on the ultrasonic sensor - change as needed - these are just what I have setup on a Baby Orangutan
...
int SonarHitRange      = 5;            // ** Make this smaller if you want to get closer to something before avoiding
...
void NormalWalk()
{
    ...
    RightHipInLimit = 120;              // Limit / Positions for Front/Center/Rear for Right Leg
    RightHipOutLimit  = 60;

    LeftAnkleCenterLimit=90;
    LeftAnkleLeftLimit = 120;
    LeftAnkleRightLimit= 60;
    
    RightAnkleCenterLimit=90;
    RightAnkleLeftLimit = 60;
    RightAnkleRightLimit= 120;
}
